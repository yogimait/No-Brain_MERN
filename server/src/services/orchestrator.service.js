...
/**
 * @deprecated
 * Orchestrator execution layer is disabled in NoBrain v2.
 * Planning utilities (topologicalSort, validateWorkflow) remain active.
 * Execution functions (runWorkflow, executeNode) are deprecated — do not call.
 */
